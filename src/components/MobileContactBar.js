...
export default function MobileContactBar() {
  ...
  const bookHref = hasValue(businessDetails.consultationUrl)
    ? businessDetails.consultationUrl
    : null;
  ...
  if (phoneHref) {
    actions.push({
      ...
      href: phoneHref,
      label: "Call",
      ariaLabel: `Call ${businessDetails.phone}`,
      onClick: () =>
        trackEvent(AnalyticsEvents.PHONE_CLICK, { location: "mobile_bar" }),
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
  ...
  if (whatsappHref) {
    actions.push({
      ...
      external: true,
      onClick: () =>
        trackEvent(AnalyticsEvents.WHATSAPP_CLICK, { location: "mobile_bar" }),
      icon: (
        <svg
          className="w-5 h-5"
          fill="currentColor"
  ...
  if (bookHref) {
    actions.push({
      ...
      href: bookHref,
      label: "Book",
      ariaLabel: "Book a consultation on Picktime (opens in a new tab)",
      external: true,
      onClick: () =>
