      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          {steps.map((step) => (
            <div
              key={step.number}
              className="card-interactive group bg-gradient-to-br from-surface-elevated to-surface p-6 md:p-8 rounded-2xl"
            >
              <div
                className="text-4xl font-bold text-gold/30 mb-3 transition-colors duration-200 group-hover:text-gold/70"
                aria-hidden="true"
              >
                {step.number}
              </div>
